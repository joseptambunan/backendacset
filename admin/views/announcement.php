    ...
    <div class="col-lg-12">
        <div class="panel panel-default">
            ...
            <div class="panel-group" id="accordion">
              <?php 
            foreach ($raw_announcement as $key) 
            {
              if($key->active == 1)
              {
                $status = 'active';
                    ...
                    <div class="panel-body">
                         <a href="<?= base_url($key->userfile) ?>"><div class="media">
                          ...
                          <div class="cat-editmulti-wrapper">
                            ...
                            <?php
                              $config = array(
                                          'admin/edit_announcement/'.$key->id => 
                                          array(
                                            array(
                                                    'type' => 'text',
                                                    'name' => 'title',
                          ...
                          <a href="admin/delete_announcement/<?= $key->id?>" class="btn btn-danger" style="margin-top: 10px" onclick="return confirm('Are you sure you want to delete?')">Delete</a>
          ...
          <div class="panel panel-default">
                <div class="panel-heading">
                    <h4 class="panel-title">
                        <a data-toggle="collapse" data-parent="#accordion" href="#collapseAdd"><h4 class="box-title">Add Announcement</h4></a>
                    </h4>
                </div>
