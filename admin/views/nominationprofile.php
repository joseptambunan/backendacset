<div class="row">
    <div class="col-lg-12">
        <h1 class="page-header">Nomination and Remuneration Committee Profile</h1>
    </div>
    <!-- /.col-lg-12 -->
</div>
<!-- /.row -->
    ...
    <div class="col-lg-12">
        <div class="panel panel-default">
            <div class="panel-heading">
                GCG > Nomination and Remuneration Committee
            </div>
            <!-- /.panel-heading -->
            <div class="panel-body">
            <div class="panel-group" id="accordion">
              <?php 
            foreach ($raw_nominationprofile as $key) 
            {
              if($key->active == 1)
              {
                $status = 'active';
                    ...
                    <div class="panel-body">
                         <img src="<?= base_url($key->userfile) ?>" class="img-responsive">
                          ...
                          <div class="cat-editmulti-wrapper">
                            ...
                            <?php
                              $config = array(
                                          'admin/edit_nominationprofile/'.$key->id => 
                                          array(
                                            array(
                                                    'type' => 'text',
                                                    'name' => 'nama',
                          ...
                          <a href="admin/delete_nominationprofile/<?= $key->id?>" class="btn btn-danger" style="margin-top: 10px" onclick="return confirm('Are you sure you want to delete?')">Delete</a>
          ...
          <div class="panel panel-default">
                <div class="panel-heading">
                    <h4 class="panel-title">
                        <a data-toggle="collapse" data-parent="#accordion" href="#collapseAdd"><h4 class="box-title">Add Nomination and Remuneration Committee Profile</h4></a>
                    </h4>
                </div>
