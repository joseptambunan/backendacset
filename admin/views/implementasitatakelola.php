<div class="row">
    <div class="col-lg-12">
        <h1 class="page-header">Implementasi Tata Kelola Perusahaan yang Baik</h1>
    </div>
    <!-- /.col-lg-12 -->
</div>
<!-- /.row -->
    ...
    <div class="col-lg-12">
        <div class="panel panel-default">
            <div class="panel-heading">
                GCG > Implementasi Tata Kelola Perusahaan yang Baik
            </div>
            <!-- /.panel-heading -->
            <div class="panel-body">
            <div class="panel-group" id="accordion">
              <?php 
            foreach ($raw_implementasitatakelola as $key) 
            {
              if($key->active == 1)
              {
                $status = 'active';
          ...
          <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                          ...
                          <div class="cat-editmulti-wrapper">
                            ...
                            <?php
                              $config = array(
                                          'admin/edit_implementasitatakelola/'.$key->id => 
                                          array(  
                                            array(
                                                    'type' => 'textarea',
                                                    'name' => 'content',
