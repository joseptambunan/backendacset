<div class="row">
    <div class="col-lg-12">
        <h1 class="page-header">Profil Komite Audit</h1>
    </div>
    <!-- /.col-lg-12 -->
</div>
<!-- /.row -->
    ...
    <div class="col-lg-12">
        <div class="panel panel-default">
            ...
            <div class="panel-group" id="accordion">
              <?php 
            foreach ($raw_profilkomiteaudit as $key) 
            {
              if($key->active == 1)
              {
                $status = 'active';
                    ...
                    <div class="panel-body">
                         <img src="<?= base_url($key->userfile) ?>" class="img-responsive">
                          ...
                          <div class="cat-editmulti-wrapper">
                            ...
                            <?php
                              $config = array(
                                          'admin/edit_profilkomiteaudit/'.$key->id => 
                                          array(
                                            array(
                                                    'type' => 'text',
                                                    'name' => 'nama',
                          ...
                          <a href="admin/delete_profilkomiteaudit/<?= $key->id?>" class="btn btn-danger" style="margin-top: 10px" onclick="return confirm('Are you sure you want to delete?')">Delete</a>
          ...
          <div class="panel panel-default">
                <div class="panel-heading">
                    <h4 class="panel-title">
                        <a data-toggle="collapse" data-parent="#accordion" href="#collapseAdd"><h4 class="box-title">Add Profil Komite Audit</h4></a>
                    </h4>
                </div>
