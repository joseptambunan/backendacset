<div class="row">
    <div class="col-lg-12">
        <h1 class="page-header">Dokumen Pendukung Tata Kelola Perusahaan</h1>
    </div>
    <!-- /.col-lg-12 -->
</div>
<!-- /.row -->
    ...
    <div class="col-lg-12">
        <div class="panel panel-default">
            <div class="panel-heading">
                GCG > Dokumen Pendukung Tata Kelola Perusahaan
            </div>
            <!-- /.panel-heading -->
            <div class="panel-body">
            <div class="panel-group" id="accordion">
              <?php 
            foreach ($raw_dokumentatakelola as $key) 
            {
              if($key->active == 1)
              {
                $status = 'active';
                    ...
                    <div class="panel-body">
                         <a href="<?= base_url($key->userfile) ?>"><div class="media">
                          ...
                          <div class="cat-editmulti-wrapper">
                            ...
                            <?php
                              $config = array(
                                          'admin/edit_dokumentatakelola/'.$key->id => 
                                          array(
                                           /* array(
                                                    'type' => 'textarea',
                                                    'name' => 'content',
                          ...
                          <a href="admin/delete_dokumentatakelola/<?= $key->id?>" class="btn btn-danger" style="margin-top: 10px" onclick="return confirm('Are you sure you want to delete?')">Delete</a>
          ...
          <div class="panel panel-default">
                <div class="panel-heading">
                    <h4 class="panel-title">
                        <a data-toggle="collapse" data-parent="#accordion" href="#collapseAdd"><h4 class="box-title">Add Dokumen Tata Kelola Perusahaan</h4></a>
                    </h4>
                </div>
