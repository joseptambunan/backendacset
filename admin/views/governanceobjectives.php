<div class="row">
    <div class="col-lg-12">
        <h1 class="page-header">Good Corporate Governance Objectives</h1>
    </div>
    <!-- /.col-lg-12 -->
</div>
<!-- /.row -->
    ...
    <div class="col-lg-12">
        <div class="panel panel-default">
            <div class="panel-heading">
                GCG > Good Corporate Governance Objectives
            </div>
            <!-- /.panel-heading -->
            <div class="panel-body">
            <div class="panel-group" id="accordion">
              <?php 
            foreach ($raw_governanceobjectives as $key) 
            {
              if($key->active == 1)
              {
                $status = 'active';
          ...
          <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                          ...
                          <div class="cat-editmulti-wrapper">
                            ...
                            <?php
                              $config = array(
                                          'admin/edit_governanceobjectives/'.$key->id => 
                                          array(  
                                            array(
                                                    'type' => 'textarea',
                                                    'name' => 'content',
