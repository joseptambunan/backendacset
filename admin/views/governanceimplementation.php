<div class="row">
    <div class="col-lg-12">
        <h1 class="page-header">Implementation of Good Corporate Governance</h1>
    </div>
    <!-- /.col-lg-12 -->
</div>
<!-- /.row -->
    ...
    <div class="col-lg-12">
        <div class="panel panel-default">
            ...
            <div class="panel-group" id="accordion">
              <?php 
            foreach ($raw_governanceimplementation as $key) 
            {
              if($key->active == 1)
              {
                $status = 'active';
          ...
          <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                          ...
                          <div class="cat-editmulti-wrapper">
                            ...
                            <?php
                              $config = array(
                                          'admin/edit_governanceimplementation/'.$key->id => 
                                          array(  
                                            array(
                                                    'type' => 'textarea',
                                                    'name' => 'content',
