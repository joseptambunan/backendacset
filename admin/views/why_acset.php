<div class="row">
    <div class="col-lg-12">
        <h1 class="page-header">Why ACSET</h1>
    </div>
    <!-- /.col-lg-12 -->
</div>
<!-- /.row -->
<div class="row">
    <div class="col-lg-12">
        <div class="panel panel-default">
          ...
          <span>Fixed <strong>6 item <i>( tidak ada penambahan atau pengurangan )</i></strong></span>
          </div>      
            </div>
            <!-- /.panel-body -->
        </div>
